...
public class IconCreator : MonoBehaviour
{
	...
	*****************************************************************/
	...
	[Header("Models")] [SerializeField] private List<GameObject> _models;
	...
	[Header("Pivot parameters"), SerializeField] private Vector3 _pivotPosition;
	[SerializeField] private Vector3 _pivotRotation;
	[SerializeField] private Vector3 _pivotScale;
	...
	*****************************************************************/
	...
	private Vector3 PivotPosition
	{
		...
		set
		{
			...
			PivotTransform.localPosition = _pivotPosition;
		}
	}
	...
	private Vector3 PivotRotation
	{
		...
		set
		{
			...
			PivotTransform.localEulerAngles = _pivotRotation;
		}
	}

	private Vector3 PivotScale
	{
		get { return _pivotScale; }
		set
		{
			_pivotScale = value;
			PivotTransform.localScale = _pivotScale;
		}
	}
	...
	*****************************************************************/
	...
	public void ChangePreviewModel()
	{
		...
		{
			((GameObject) Instantiate(Models[CurrentIndex], PivotTransform.position, Quaternion.identity, PivotTransform))
	...
	private void RenderIcon(GameObject model)
	{
		UpdateModelLocation();
		...
		((GameObject)Instantiate(model, PivotTransform.position, Quaternion.identity, PivotTransform)).transform.localEulerAngles = Vector3.zero;
