...
[System.Serializable]
[Category("amindler/Flow control")]
public class PlayerDecisionAndItemNode : NodeBase, IPlayerDecisionAndItemNode {

	public override NodeUIBase uiPrefab
	{
		get { return QuestManager.instance.settingsDatabase.playerDecisionAndItemNodeUI; }
	}
	...
	[HideTypePicker]
	[HideGroup(false)]
	private PlayerDecisionAndItem[] _playerDecisions = new PlayerDecisionAndItem[0];
	public PlayerDecisionAndItem[] playerDecisions
	{
